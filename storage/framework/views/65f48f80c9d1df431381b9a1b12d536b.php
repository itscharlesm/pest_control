<div class="modal fade" id="userPasswordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(action('App\Http\Controllers\UserController@update_password')); ?>">
...
</div><?php /**PATH C:\laragon\www\pest_control\resources\views/layouts/partials/modals.blade.php ENDPATH**/ ?>