...
@section('content')
    ...
    @foreach ($clients as $client)
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            @php
                                $clientAddresses = $addresses[$client->usr_id] ?? collect();
                            @endphp
        ...
        <div class="modal fade" id="resetModal-{{ $client->usr_id }}" tabindex="-1" role="dialog"
        ...
        {{-- Delete Modal --}}
        <div class="modal fade" id="deleteModal-{{ $client->usr_id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST"
                        ...
                        <div class="modal-body">
                            <p>Are you sure you want to <strong>DELETE</strong> client
