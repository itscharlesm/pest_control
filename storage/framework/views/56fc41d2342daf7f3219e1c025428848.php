    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a href="<?php echo e(action('App\Http\Controllers\LoginController@logout')); ?>" class="dropdown-item">
                    <i class="fas fa-sign-out" mr-2></i> Sign out
                </a>
            </div>
        </li>
    </ul>
</nav><?php /**PATH C:\laragon\www\pest_control\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>