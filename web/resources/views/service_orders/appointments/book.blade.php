                            ...
                            <table id="profilingTable" class="table table-hover table-bordered table-sm responsive">
                                ...
                                <tbody>
                                    @foreach ($clients as $client)
                                        ...
                                        <div class="modal fade" id="bookAppointmentModal-{{ $client->usr_id }}"
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            {{-- ASSIGN BRANCH --}}
                                                            <div class="form-group">
                                                                <label>Assign Branch: <span
                                                                        class="text-danger">*</span></label>
                                                                <select class="form-control book-branch-select"
                                                                    name="branch_id" data-client="{{ $client->usr_id }}"
                                                                    required>
                                                            ...
                                                            <div class="form-group book-area-group-{{ $client->usr_id }}"
                                                                style="display:none;">
                                                                <label>Location <span class="text-danger">*</span></label>
                                                                <select class="form-control book-area-select"
                                                                    name="svcpa_id" data-client="{{ $client->usr_id }}">
                                                                    <option value="">— Select Branch First —</option>

                                                                    {{-- Pre-render all areas grouped by branch as data attributes --}}
                                                                    @foreach ($servicePackageAreas as $branchId => $areas)
                                                                        @foreach ($areas as $area)
                                                                            <option value="{{ $area->svcpa_id }}"
                                                                                data-branch="{{ $branchId }}"
                                                                                data-cost="{{ $area->svcpa_cost }}"
                                                                                style="display:none;">
                                                                                {{ $area->svcpa_area }}
                                                                            </option>
                                                                        @endforeach
                                                                ...
                                                                <small
                                                                    class="text-muted book-area-cost-{{ $client->usr_id }}"></small>
                                                            </div>

                                                            {{-- Termite Treatment Size — shown when svcp_id == 9 --}}
                                                            <div class="form-group book-termite-group-{{ $client->usr_id }}"
                                                                style="display:none;">
                                                                <label>Termite Treatment Size <span
                                                                        class="text-danger">*</span></label>
                                                                <select class="form-control book-termite-select"
                                                                    name="svcpat_id" data-client="{{ $client->usr_id }}">
                                                                    <option value="">— Select Branch First —</option>

                                                                    @foreach ($termiteAreas as $branchId => $tAreas)
                                                                        @foreach ($tAreas as $t)
                                                                            <option value="{{ $t->svcpat_id }}"
                                                                                data-branch="{{ $branchId }}"
                                                                                style="display:none;">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Time Window <span
                                                                        class="text-danger">*</span></label>
                                                                <select class="form-control" name="svca_client_time"
                                                                    required>
